...
async function main() {
  ...
  try {
    ...
    try {
      ...
      await mintToken(wallet, payerTokenAccount, token0Mint, depositAmount * 2);
    }
    ...
    console.log("✅ 存入 offchain 奖励提案创建成功:", proposalResult);
    ...
    console.error("❌ 存入 offchain 奖励提案失败:", error);
  }
}
